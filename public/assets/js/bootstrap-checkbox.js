...
!function($) {
            ...
            var template = 
            	'<span class="button-checkbox bootstrap-checkbox">' +
            		'<button type="button" class="btn clearfix'+additionalButtonStyle+'">' +
	                    ...
	                    '<span class="icon fa '+this.options.checkedClass+'" style="display:none;"></span>' +
	                    '<span class="icon fa '+this.options.uncheckedClass+'"></span>' +
	                    '<span class="icon fa '+this.options.indeterminateClass+'" style="display:none;"></span>' +
    ...
    $.fn.checkbox.defaults = {
        ...
        checkedClass: 'fa-square-o',
        uncheckedClass: 'fa-check-square-o',
